        ...
        <h1>Loan</h1>
                            <form>
                                ...
                                <div className="requestManipulationRow">
                                    ...
                                    <input
                                    value={requester.nationalId}
                                    />
                                </div>
                                <div className="requestManipulationRow">
                                    <label>Telphone:</label>
                                    <input
                                    value = {`(+250) ${requester.telephone}`}
                                    />
                                </div>
                                <div className="requestManipulationRow">
                                    <label>Item:</label>
                                    <input
                                    value={selectedRequest.productTitle}
                                    />
                                </div>
                                <div className="requestManipulationRow">
                                ...
                                <div className="requestManipulationRow">
                                    <label>Total:</label>
                                    <input
                                    value= {`${selectedRequest.total} FRW`}
                                    />
                                </div>
                                <div className="requestManipulationRow">
                                    <label>RequestedDate:</label>
                                    <input
                                    value={moment(selectedRequest.requestedDate).format('MMMM Do, YYYY')}
                                    />
                                </div>
                                <div className="requestManipulationRow">
                                    <label>TobePayed:</label>
                                    <input
                                    value={moment(selectedRequest.tobePayed).format('MMMM Do, YYYY')}
                                    />
                                </div>
                                <div className="requestManipulationRow">
