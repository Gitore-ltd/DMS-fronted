...
export const userSignup = (authPayload) => async (dispatch) => {
  const res = await fetch(
    `https://debt-management-system.herokuapp.com/api/v1/auth/signup`,
    {
      method: 'POST',
      headers: {
...
export const userSignin = (authPayload) => async (dispatch) => {
  try {
    const res = await fetch(
      `https://debt-management-system.herokuapp.com/api/v1/auth/login`,
      {
        method: 'POST',
        headers: {
          'content-type': 'application/json',
...
export const userProfile = (authPayload) => async (dispatch) => {
  ...
  const res = await fetch(
    `https://debt-management-system.herokuapp.com/api/v1/updateProfile`,
    {
      method: 'PATCH',
      headers: {
        'content-type': 'application/json',
